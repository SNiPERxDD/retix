...
### Fixed
- **Absolute path leak in benchmark tool**: Changed hardcoded `/Users/abhinavarao/Downloads/test.jpeg` to portable `Path.home() / "Downloads" / "test.jpeg"` with fallback to current directory.
